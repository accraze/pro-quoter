...
if (!is_administrator()) {
	print '<h2>Access Denied!</h2><p class="error">You do not have permission to access this [age.</p>';
...
if ($r = mysql_query($query, $dbc)) {
   ...
   while ($row = mysql_fetch_array($r)) {
      ...
      <a href=\"delete_quote.php?id={$row['quote_id']}\">Delete</a></p></div>\n";
   	...
   	print '<p class="error">Could not retrive the data because:<br />' . mysql_error($dbc) . '.</p>
