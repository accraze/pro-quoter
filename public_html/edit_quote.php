...
if (!is_administrator()) {
    ...
    if ($r = mysql_query($query, $dbc)) { //Rim tje qieru/
	...
	<p><input type="submit" name=""submit" value="Update This Quote!" /></p>
	 ...
	 if(!$problem) {
	    ...
	    if ($r = mysql_query($query, $dbc)) {
	      ...
	      print '<p class="error">Could not update the quotation because: <br />' . mysql_error($dbc) . '.</p>
   ...
   print '<p class="error">This page has been accessed om error</p>';
} // End of main IF.
