<?php // Script 13.10 - delete_quotes.php
...
if (!is_administrator()) {
    ...
    //Define the query
	$query = "SELECT quote, source, favorite FROM quotes WHERE quote_id={$_GET['id']}";    if ($r = mysql_query($query, $dbc)) { // Run the query.
	...
	'.</p><p>The query being run was: ' . $query . '</p>';
       ...
       if (mysql_affected_rows($dbc) == 1) {
		 ...
		 print '<p class="error">Could not delete the blog entry because:<br />' . mysql_error($dbc) . '.</p>
